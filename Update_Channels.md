...
🟢 Premier Sport 1 🇬🇧 [Pʀᴇᴍɪuᴍ Sᴘoʀᴛs]
🟢 Dark Matterᴴᴰ 🇧🇷 [portugal]
🟢 Eurosport 1 🇵🇹 (Test) [portugal]
🟢 Eleven Sports2|Eurosport2 🇵🇹 (Test) [Pʀᴇᴍɪuᴍ Sᴘoʀᴛs]
🟢 Fox Sport 2 🇧🇷 (test) [Lɪɢᴀ Bwɪɴ]
🟢 TNT Seriesᴴᴰ 🇧🇷 (Leg)
...
📢 🚨❗ Não se esqueçam, para verem os canais Acestream no simpletv, têm que ter o player Acestream instalado. 
...
📌 Se encontrar à frente do nome do canal este símbolo ❔❔ (Test). Significa que o canal em questão está a ser testado para sabermos se vale a pena te-lo na lista
